...
export function TokenLaunchpad() {
    ...
    return  <div style={{
        ...
        <input className='input-box' type='text' placeholder='Name'></input> <br />
        <input className='input-box' type='text' placeholder='Symbol'></input> <br />
        <input className='input-box' type='text' placeholder='Image URL'></input> <br />
        <input className='input-box' type='text' placeholder='Initial Supply'></input> <br />
